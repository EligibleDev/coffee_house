    ...
    return (
        <>
            <Parallax
                ...
                strength={750}
            >
                <div className="max-w-screen-xl mx-auto py-10 lg:py-20 px-4 xl:px-0 text-center">
                    <Title
                        className="mb-16"
                        ...
                        <SwiperSlide>
                            <div className="text-center w-full lg:w-3/4 mx-auto ">
                                <h3 className="text-lg md:text-2xl font-jost italic">
                                   Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloribus expedita quaerat nobis nesciunt enim aperiam maiores? Eum officiis excepturi, voluptatum temporibus alias, iusto optio distinctio omnis cum eos nihil dolorum illum rerum asperiores aperiam accusantium?
                                </h3>
